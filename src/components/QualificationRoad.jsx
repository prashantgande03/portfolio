    ...
    return (
        <section ref={sectionRef} id="qualification" className="relative overflow-hidden px-4 py-24 sm:px-6" style={{ minHeight: "200vh" }}>
            ...
            <div className="sticky top-20">
                ...
                <div className="relative mx-auto mt-12 max-w-4xl perspective">
                    <div className="relative mx-auto" style={{
                        ...
                        {items.map((item, i) => {
                            ...
                            return (
                                <div key={`card-${i}`} className="absolute overflow-hidden rounded-xl border bg-card/90 p-4 text-left backdrop-blur transition-all duration-500" style={{
                                    ...cardStyle,
                ...
                {finished && (
                    <div className="relative mx-auto mt-10 max-w-md animate-fade-up rounded-xl border border-[var(--neon-pink)] bg-card/90 p-5 text-center backdrop-blur" style={{ boxShadow: "0 0 60px var(--neon-pink)" }}>
